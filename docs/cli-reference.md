...
Session files are limited to 2 MiB. Each session can contain up to 2,048
cookies (64 per domain); cookie names and values are limited to 256 and 4,096
bytes. Cookies rejected or evicted by these limits produce a bounded warning.
